...
NATIVE = {
    'cairosvg': {
        ...
        'Darwin': [
            'brew install cairo',
            '',
            'On Apple Silicon (M1/M2/M3/M4), Homebrew installs to',
            '/opt/homebrew, which cairocffi does not search by default — so',
            'the library is present and still not found. If it still fails:',
            '',
            '  export DYLD_FALLBACK_LIBRARY_PATH=/opt/homebrew/lib:$DYLD_FALLBACK_LIBRARY_PATH',
            '',
            'Add that line to ~/.zshrc to make it stick, then open a new',
